        ...
        section9(){
            ...
            $(window).scroll(function(){
                ...
                if($(window).scrollTop() === 0){
                    $('#section9 .box1, #section9 .box2, #section9 .box3').removeClass('on');
                }
                if($(window).scrollTop() >= sec8Top){
                    $('#section9 .box1, #section9 .box2, #section9 .box3').addClass('on');
                }
            });
        },
        section10(){
            // const sec9Top = $('#section9').offset().top + 300;

            // $(window).scroll(function(){

            //     if($(window).scrollTop() === 0){
            //         $('#section10 .box-1, #section10 .box-2, #section10 .box-3').removeClass('on');
            //     }
            //     if($(window).scrollTop() >= sec9Top){
            //         $('#section10 .box-1, #section10 .box-2, #section10 .box-3').addClass('on');
            //     }
            // })
        },
        go(){
